...
public enum BusinessErrorCode {
    ...
    AUDIENCE_DOES_NOT_MATCH("EDOT0010400", "Audience doesn't match", HttpStatus.BAD_REQUEST),
    ...
    NO_JWT_AUTH_FOUND("EDOT0028500", "No JWT Auth found in Security Context.", HttpStatus.INTERNAL_SERVER_ERROR),
