...
public enum BusinessErrorCode {
    ...
    USER_NOT_FOUND("EDOT0030404", "Employee with given username not found", HttpStatus.NOT_FOUND),
    LOGIN_INACTIVE_USER("EDOT0031403", "User can't login, status is INACTIVE", HttpStatus.FORBIDDEN);
