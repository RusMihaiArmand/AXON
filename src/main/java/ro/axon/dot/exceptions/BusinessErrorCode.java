...
public enum BusinessErrorCode {
    ...
    NEGATIVE_DAYS_OFF("EDOT0014500", "Number of days off became negative.", HttpStatus.BAD_REQUEST),
    EMPLOYEE_VERSION_CONFLICT("EDOT0015409", "Conflict on employee version.", HttpStatus.CONFLICT),
    TEAM_NOT_FOUND("EDOT0016400", "The given team ID does not exist", HttpStatus.BAD_REQUEST);
