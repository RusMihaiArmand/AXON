...
public class EmployeeTestAttributes {
  ...
  public static final Instant CRT_TMS = clock.instant();
  public static final String MDF_USR = "user2";
  public static final Instant MDF_TMS = clock.instant();
  public static final String  ROLE = "HR";
  public static final String STATUS = "ACTIVE";
  public static final LocalDate CONTRACT_START_DATE = LocalDate.ofInstant(clock.instant(), clock.getZone());
  public static final LocalDate CONTRACT_END_DATE = LocalDate.ofInstant(clock.instant(), clock.getZone());
